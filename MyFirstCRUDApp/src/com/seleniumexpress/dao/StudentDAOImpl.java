...
public class StudentDAOImpl implements StudentDAO {
	...
	public void insert(Student student) {
		...
		Object[] arg = { student.getID(), student.getName(), student.getAddress() };
...
//dodato za delete funkciju, part 2
	...
	public void insert(List<Student> students) {
		...
		for (Student tempStudent : students) {
			...
			Object[] studentData = { tempStudent.getID(), tempStudent.getName(), tempStudent.getAddress() };
...
// koriscen Spring row mapper tj BeanPropertyRowMapper klasa
	@Override
	public Student findStudentsByRollNo(int id) {
		String selectSql = "SELECT ID as id, " + "STUDENT_NAME as name, " + "STUDENT_ADDR as address "
		...
		public int updateStudent(Student student) {
			...
			String sql = "UPDATE school.student set STUDENT_ADDR = ? WHERE ID = ?";
		...
		public int updateStudent(List<Student> studentList) {
			...
			jdbcTemplate.batchUpdate(sql, new BatchPreparedStatementSetter() {
				...
				@Override
				// argumenti za "UPDATE school.student set STUDENT_ADDR = ? WHERE ID = ?"
				public void setValues(PreparedStatement arg0, int arg1) throws SQLException {
		
				arg0.setString(1, studentList.get(arg1).getAddress());  //laz
				arg0.setInt(2, studentList.get(arg1).getID());  // 3
